# ![nf-core/adnamap](docs/images/nf-core-adnamap_logo_light.png#gh-light-mode-only) ![nf-core/adnamap](docs/images/nf-core-adnamap_logo_dark.png#gh-dark-mode-only)
